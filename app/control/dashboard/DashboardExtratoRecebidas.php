...
class DashboardExtratoRecebidas extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_DashboardExtratoRecebidas';
    ...
    public function __construct( $param = null)
    {
        ...
        $this->form->setFormTitle("Dashboard de recebidas");
        ...
        $filterVar = [TipoExtrato::RECEBER, TipoExtrato::ENTRADA];
        ...
        $atalho->setUseButton();
        $button_buscar->setAction(new TAction(['DashboardExtratoRecebidas', 'onShow']), "Buscar");
        ...
        $compensado->setFieldValue("extrato.entrada_valor");
        ...
        $receber->setFieldValue("extrato.entrada_valor");
        ...
        $total->setFieldValue("extrato.entrada_valor");
        ...
        $por_categoria->setFieldValue("extrato.entrada_valor");
        ...
        $movimentacao_mes->setFieldValue("extrato.entrada_valor");
        ...
        $movimento->setFieldValue("extrato.entrada_valor");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Dashboard","Dashboard de recebidas"]));
        }
