...
class ContratoAlterarStatusForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        parent::setTitle("Alterar Status de Contrato");
        ...
        $this->form->setFormTitle("Alterar Status de Contrato");
        ...
        $row1 = $this->form->addFields([new TLabel("Status:", null, '14px', null)],[$contrato_status_id,$id]);
