...
class ContratoFormSemRepasse extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $action_onEditDetailContratoPagamentoParcela = new TDataGridAction(array('ContratoFormSemRepasse', 'onEditDetailContratoPagamentoParcela'));
        ...
        $action_onDeleteDetailContratoPagamentoParcela = new TDataGridAction(array('ContratoFormSemRepasse', 'onDeleteDetailContratoPagamentoParcela'));
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ContratoFormSemRepasse]');
