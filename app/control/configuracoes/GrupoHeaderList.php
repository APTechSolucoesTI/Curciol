...
class GrupoHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['GrupoHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['GrupoHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['GrupoHeaderList', 'onExportXls']), self::$formName, 'fas:file-excel #4CAF50' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Configurações","Grupos"]));
        }
