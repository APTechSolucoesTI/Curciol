...
class CategoriaContaForm extends TPage
{
    ...
    private static $formName = 'form_CategoriaContaForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de categoria conta");
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Tipo conta:", '#ff0000', '14px', null, '100%'),$tipo_conta_id]);
        ...
        $btn_onshow = $this->form->addAction("Sair", new TAction(['CategoriaContaHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new CategoriaConta(); // create an empty object 
            ...
            TApplication::loadPage('CategoriaContaHeaderList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new CategoriaConta($key); // instantiates the Active Record 
