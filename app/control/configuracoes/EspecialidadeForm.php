...
class EspecialidadeForm extends TPage
{
    ...
    private static $formName = 'form_EspecialidadeForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de especialidade");
        ...
        $row3 = $this->form->addFields([new TLabel("Criado em:", null, '14px', null, '100%'),$data_criacao],[new TLabel("Criado por:", null, '14px', null, '100%'),$criacao_user_name],[new TLabel("Atualizado em:", null, '14px', null, '100%'),$data_modificacao],[new TLabel("Atualizado por:", null, '14px', null),$modificacao_user_name]);
        ...
        $btn_onshow = $this->form->addAction("Sair", new TAction(['EspecialidadeHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Especialidade(); // create an empty object 
            ...
            TApplication::loadPage('EspecialidadeHeaderList', 'onShow', $loadPageParam); 
