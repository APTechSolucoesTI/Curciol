...
class TipoPagamentoForm extends TPage
{
    ...
    private static $formName = 'form_TipoPagamento';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tipo pagamento");
        ...
        $btn_onshow = $this->form->addAction("Sair", new TAction(['TipoPagamentoHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new TipoPagamento(); // create an empty object 
            ...
            TApplication::loadPage('TipoPagamentoHeaderList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TipoPagamento($key); // instantiates the Active Record 
