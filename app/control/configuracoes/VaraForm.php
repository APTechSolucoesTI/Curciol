...
class VaraForm extends TPage
{
    ...
    private static $formName = 'form_VaraForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de vara");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['VaraList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Vara(); // create an empty object 
            ...
            TApplication::loadPage('VaraList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Vara($key); // instantiates the Active Record 
