...
class AssuntoProcessoForm extends TPage
{
    ...
    private static $formName = 'form_AssuntoProcessoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de assunto do processo");
        ...
        $area_id->addValidation("Area processo id", new TRequiredValidator()); 
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Área:", '#ff0000', '14px', null, '100%'),$area_id]);
        ...
        $row5 = $this->form->addFields([new TLabel("Criado em:", null, '14px', null, '100%'),$data_criacao],[new TLabel("Criado por:", null, '14px', null, '100%'),$criacao_user_id],[new TLabel("Atualizado em:", null, '14px', null, '100%'),$data_modificacao],[new TLabel("Atualizado por:", null, '14px', null, '100%'),$modificacao_user_id]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['AssuntoProcessoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Assunto(); // create an empty object 
            ...
            TApplication::loadPage('AssuntoProcessoList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Assunto($key); // instantiates the Active Record 
