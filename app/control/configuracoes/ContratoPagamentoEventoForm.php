...
class ContratoPagamentoEventoForm extends TPage
{
    ...
    private static $formName = 'form_ContratoPagamentoEventoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de evento de pagamento de contrato");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['ContratoPagamentoEventoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new ContratoPagamentoEvento(); // create an empty object 
            ...
            TApplication::loadPage('ContratoPagamentoEventoList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new ContratoPagamentoEvento($key); // instantiates the Active Record 
