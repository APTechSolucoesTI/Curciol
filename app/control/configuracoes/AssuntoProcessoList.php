...
class AssuntoProcessoList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'Assunto';
    private static $primaryKey = 'id';
    private static $formName = 'form_AssuntoProcessoList';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de assuntos do processo");
        $this->limit = 20;
        ...
        $action_onDelete = new TDataGridAction(array('AssuntoProcessoList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de assuntos do processo");
        ...
        $button_cadastrar->setAction(new TAction(['AssuntoProcessoForm', 'onShow']), "Cadastrar");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['AssuntoProcessoList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['AssuntoProcessoList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atualizar->setAction(new TAction(['AssuntoProcessoList', 'onRefresh']), "Atualizar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['AssuntoProcessoList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['AssuntoProcessoList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['AssuntoProcessoList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['AssuntoProcessoList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Configurações","Assuntos do processo"]));
        }
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'AssuntoProcessoListSearch');
            $page->setProperty('page_name', 'AssuntoProcessoListSearch');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Assunto
