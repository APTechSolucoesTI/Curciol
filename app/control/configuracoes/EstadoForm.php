...
class EstadoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Código do IBGE:", '#FF0000', '14px', null),$codigo_ibge],[new TLabel("Sigla:", '#ff0000', '14px', null, '100%'),$sigla]);
        ...
        $btn_onshow = $this->form->addAction("Sair", new TAction(['EstadoHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('EstadoHeaderList', 'onShow', $loadPageParam); 
