...
class OrgaoForm extends TPage
{
    ...
    private static $formName = 'form_OrgaoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de orgão");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['OrgaoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Orgao(); // create an empty object 
            ...
            TApplication::loadPage('OrgaoList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Orgao($key); // instantiates the Active Record 
