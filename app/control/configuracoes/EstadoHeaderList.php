...
class EstadoHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $column_sigla = new TDataGridColumn('sigla', "Sigla", 'center' , '150px');
        $column_codigo_ibge = new TDataGridColumn('codigo_ibge', "Código do IBGE", 'center' , '150px');
        ...
        $button_atualizar->setAction(new TAction(['EstadoHeaderList', 'onRefresh']), "Atualizar");
        ...
        $button_limpar_filtros->setAction(new TAction(['EstadoHeaderList', 'onClearFilters']), "Limpar filtros");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['EstadoHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:table #00b894' );
        ...
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['EstadoHeaderList', 'onExportXls']), self::$formName, 'fas:file-excel #4CAF50' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Configurações","Estados"]));
        }
