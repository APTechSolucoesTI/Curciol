...
class TipoContaForm extends TPage
{
    ...
    private static $formName = 'form_TipoConta';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tipo conta");
        ...
        $btn_onshow = $this->form->addAction("Sair", new TAction(['TipoContaHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new TipoConta(); // create an empty object 
            ...
            TApplication::loadPage('TipoContaHeaderList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TipoConta($key); // instantiates the Active Record 
