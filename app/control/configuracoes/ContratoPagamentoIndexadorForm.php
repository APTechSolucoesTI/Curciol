...
class ContratoPagamentoIndexadorForm extends TPage
{
    ...
    private static $formName = 'form_ContratoPagamentoIndexadorForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de indexador de pagamento de contrato");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['ContratoPagamentoIndexadorList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new ContratoPagamentoIndexador(); // create an empty object 
            ...
            TApplication::loadPage('ContratoPagamentoIndexadorList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new ContratoPagamentoIndexador($key); // instantiates the Active Record 
