...
class ClassificacaoClienteForm extends TPage
{
    ...
    private static $formName = 'form_ClassificacaoClienteForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de classificacao cliente");
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Classificação:", '#ff0000', '14px', null, '100%'),$nome]);
        $row1->layout = [' col-sm-3',' col-sm-9'];

        $row2 = $this->form->addContent([new TFormSeparator("", '#333', '18', '#797979')]);
        $row3 = $this->form->addFields([new TLabel("Criado em:", null, '14px', null, '100%'),$data_criacao],[new TLabel("Criado por:", null, '14px', null, '100%'),$criacao_user_name],[new TLabel("Atualizado em:", null, '14px', null, '100%'),$data_modificacao],[new TLabel("Atualizado por:", null, '14px', null, '100%'),$modificacao_user_name]);
        ...
        $btn_onshow = $this->form->addAction("Sair", new TAction(['ClassificacaoClienteHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Classificacoes(); // create an empty object 
            ...
            TApplication::loadPage('ClassificacaoClienteHeaderList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Classificacoes($key); // instantiates the Active Record 
