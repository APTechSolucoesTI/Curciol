...
class StatusProcessualForm extends TPage
{
    ...
    private static $formName = 'form_StatusProcessualForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de status processual");
        ...
        $tipo_processo_id->addValidation("Tipo processo id", new TRequiredValidator()); 
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Tipo de processo:", '#ff0000', '14px', null, '100%'),$tipo_processo_id]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['StatusProcessualList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new StatusProcessual(); // create an empty object 
            ...
            TApplication::loadPage('StatusProcessualList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new StatusProcessual($key); // instantiates the Active Record 
