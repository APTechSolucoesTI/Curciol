...
class TipoModeloDocumentoForm extends TPage
{
    ...
    private static $formName = 'form_TipoModeloDocumentoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tipo de modelo de documento");
        ...
        $row4 = $this->form->addFields([new TLabel("Criado em:", null, '12px', null, '100%'),$data_criacao],[new TLabel("Criado por:", null, '12px', null, '100%'),$criacao_user_id],[new TLabel("Atualizado em:", null, '12px', null, '100%'),$data_modificacao],[new TLabel("Atualizado por:", null, '12px', null, '100%'),$modificacao_user_id]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TipoModeloDocumentoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new TipoModeloDocumento(); // create an empty object 
            ...
            TApplication::loadPage('TipoModeloDocumentoList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TipoModeloDocumento($key); // instantiates the Active Record 
