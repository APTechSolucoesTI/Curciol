...
class CidadeHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $estado_id = new TDBCombo('estado_id', 'escritorio', 'Estado', 'id', '{nome}','nome asc' , $criteria_estado_id );
        ...
        $estado_id->setChangeAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        ...
        $column_estado_nome = new TDataGridColumn('estado->nome', "Estado", 'left' , '200px');
        $column_codigo_ibge = new TDataGridColumn('codigo_ibge', "Código IBGE", 'center' , '150px');
        ...
        $action_onDelete = new TDataGridAction(array('CidadeHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de cidades");
        ...
        $button_cadastrar->setAction(new TAction(['CidadeForm', 'onShow']), "Cadastrar");
        ...
        $button_atualizar->setAction(new TAction(['CidadeHeaderList', 'onRefresh']), "Atualizar");
        ...
        $button_limpar_filtros->setAction(new TAction(['CidadeHeaderList', 'onClearFilters']), "Limpar filtros");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['CidadeHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['CidadeHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Configurações","Cidades"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            ...
            catch (Exception $e) // in case of exception
            {
                ...
                new TMessage('error', 'Esse registro está sendo utilizado em outras partes do sistema');
