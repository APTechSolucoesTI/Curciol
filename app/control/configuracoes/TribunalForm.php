...
class TribunalForm extends TPage
{
    ...
    private static $formName = 'form_TribunalForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tribunal");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TribunalList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Tribunal(); // create an empty object 
            ...
            TApplication::loadPage('TribunalList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Tribunal($key); // instantiates the Active Record 
