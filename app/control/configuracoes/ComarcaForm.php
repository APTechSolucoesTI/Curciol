...
class ComarcaForm extends TPage
{
    ...
    private static $formName = 'form_ComarcaForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de comarca");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['ComarcaList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Comarca(); // create an empty object 
            ...
            TApplication::loadPage('ComarcaList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Comarca($key); // instantiates the Active Record 
