...
class CidadeForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $codigo_ibge->addValidation("Código do IBGE", new TRequiredValidator()); 
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Código do IBGE:", '#FF0000', '14px', null),$codigo_ibge],[new TLabel("Estado:", '#ff0000', '14px', null, '100%'),$estado_id]);
        ...
        $btn_onshow = $this->form->addAction("Sair", new TAction(['CidadeHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('CidadeHeaderList', 'onShow', $loadPageParam); 
