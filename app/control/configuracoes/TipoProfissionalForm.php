...
class TipoProfissionalForm extends TPage
{
    ...
    private static $formName = 'form_TipoProfissionalForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tipo de profissional");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TipoProfissionalList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new TipoProfissional(); // create an empty object 
            ...
            TApplication::loadPage('TipoProfissionalList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TipoProfissional($key); // instantiates the Active Record 
