...
class FormularioHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_Formulario';
    ...
    public function __construct($param = null)
    {
        ...
        $column_ordem = new TDataGridColumn('ordem', "Ordem de exibição", 'center' , '150px');
        ...
        $column_ordem->setTransformer( function($value, $object, $row) {
            ...
            $ordem = new TEntry($object->$pk.'_'.'ordem');
            $ordem->setSize('100%');
            $ordem->setMask('999');
        ...
        $action_onEdit = new TDataGridAction(array('FormularioForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FormularioHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de formulários");
        ...
        $button_cadastrar->setAction(new TAction(['FormularioForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['FormularioHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['FormularioHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['FormularioHeaderList', 'onExportXls']), self::$formName, 'fas:file-excel #4CAF50' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Configurações","Formulários"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new Fomulario($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Formulario
