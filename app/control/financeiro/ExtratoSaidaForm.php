...
class ExtratoSaidaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Valor:", '#FF0000', '14px', null, '100%'),$saida_valor],[new TLabel("Categoria de conta:", null, '14px', null, '100%'),$categoria_conta_id]);
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ExtratoSaidaForm]');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            if(!$object->id){
                ...
                $object->tipo_extrato_id = TipoExtrato::SAIDA;
            }else{
