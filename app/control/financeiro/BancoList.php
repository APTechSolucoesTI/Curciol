...
class BancoList extends TPage
{
    ...
    private static $formName = 'form_BancoList';
    ...
    public function __construct($param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Codigo:", null, '14px', null, '100%'),$codigo]);
        ...
        $column_codigo = new TDataGridColumn('codigo', "Codigo", 'left' , '30%');
        ...
        $panel = new TPanelGroup("Listagem de bancos");
        ...
        $button_cadastrar->setAction(new TAction(['BancoForm', 'onShow']), "Cadastrar");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['BancoList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['BancoList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atualizar->setAction(new TAction(['BancoList', 'onRefresh']), "Atualizar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['BancoList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['BancoList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['BancoList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['BancoList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Financeiro","Bancos"]));
        }
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'BancoListSearch');
            $page->setProperty('page_name', 'BancoListSearch');
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->codigo) AND ( (is_scalar($data->codigo) AND $data->codigo !== '') OR (is_array($data->codigo) AND (!empty($data->codigo)) )) )
        {
            ...
            $filters[] = new TFilter('codigo', '=', $data->codigo);// create the filter 
        }
