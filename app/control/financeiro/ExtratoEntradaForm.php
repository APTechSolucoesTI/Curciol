...
class ExtratoEntradaForm extends TPage
{
    ...
    private static $formName = 'form_ExtratoForm';
    ...
    public function __construct( $param )
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Conta caixa:", '#ff0000', '14px', null, '100%'),$conta_caixa_id],[new TLabel("Escritório:", '#ff0000', '14px', null, '100%'),$escritorio_id]);
        $row1->layout = [' col-sm-4',' col-sm-4',' col-sm-4'];

        $row2 = $this->form->addFields([new TLabel("Valor:", '#FF0000', '14px', null, '100%'),$entrada_valor],[new TLabel("Categoria de conta:", null, '14px', null, '100%'),$categoria_conta_id]);
        $row2->layout = ['col-sm-6','col-sm-6'];

        $row3 = $this->form->addFields([new TLabel("Histórico:", null, '14px', null, '100%'),$historico],[new TLabel("Compensado:", null, '14px', null, '100%'),$compensado],[new TLabel("Data da compensação:", null, '14px', null, '100%'),$data_compensacao]);
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ExtratoEntradaForm]');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            if(!$object->id){
                $object->data_lancamento = date('Y-m-11');
                $object->tipo_extrato_id = TipoExtrato::ENTRADA;
            }else{
