...
class TipoAndamentoForm extends TPage
{
    ...
    private static $formName = 'form_TipoAndamentoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tipo de andamento");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TipoAndamentoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new TipoAndamento(); // create an empty object 
            ...
            TApplication::loadPage('TipoAndamentoList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TipoAndamento($key); // instantiates the Active Record 
