...
class EnvolvimentoForm extends TPage
{
    ...
    private static $formName = 'form_EnvolvimentoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de envolvimento");
        ...
        $row2 = $this->form->addFields([new TLabel("Tipo de processo:", '#ff0000', '14px', null, '100%'),$tipo_processo_id]);
        $row2->layout = ['col-sm-6'];

        $row3 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['EnvolvimentoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Envolvimento(); // create an empty object 
            ...
            TApplication::loadPage('EnvolvimentoList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Envolvimento($key); // instantiates the Active Record 
