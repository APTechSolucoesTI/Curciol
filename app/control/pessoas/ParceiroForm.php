...
class ParceiroForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $action_onEditDetailPessoaEndereco = new TDataGridAction(array('ParceiroForm', 'onEditDetailPessoaEndereco'));
        ...
        $action_onDeleteDetailPessoaEndereco = new TDataGridAction(array('ParceiroForm', 'onDeleteDetailPessoaEndereco'));
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ParceiroForm]');
        $style->width = '70% !important';   
        $style->show(true);

    }

    //<generated-exitAction-onChange>
...
//</generated-exitAction-onChange>
    ...
    //<generated-changeAction-onLoadDocuments>
...
//</generated-changeAction-onLoadDocuments>
    ...
    //<generated-FormAction-onChangeNome>
        ...
        try 
        {
            if(empty($param['id']) && !empty($param['nome'])){
                ...
                if($count>0){
                    ...
                    $pageParam['nova_pessoa_grupo'] = Grupo::PARCEIRO;
...
//</generated-FormAction-onChangeNome>
    ...
    //<generated-FormAction-onSearchCep>
...
//</generated-FormAction-onSearchCep>
    ...
    //<generated-FormAction-onAddDetailPessoaEnderecoPessoa>
    public  function onAddDetailPessoaEnderecoPessoa($param = null) 
    {
        try
        {
            ...
            //</detailForm-2849843-23608167-RequiredFieldsOnAddAutoCode> //</hideLine>
            //<generatedAutoCode>
            $errors = [];
            $requiredFields = [];
            ...
            //</detailForm-2849843-23608167-GridDataOnAddAutoCode> //</hideLine>
            //<generatedAutoCode>
            ...
            //</detailForm-2849843-23608167-ClearDataOnAddAutoCode> //</hideLine>
            //<generatedAutoCode>
            ...
            //</detailForm-2849843-23608167-SendDataOnAddAutoCode> //</hideLine>
            //<generatedAutoCode>
            TForm::sendData(self::$formName, $data);
            TScript::create("
...
//<generated-DatagridAction-onEditDetailPessoaEndereco>
    public static function onEditDetailPessoaEndereco($param = null) 
    {
        try
        {
            //</detailForm-2849843-23608167-AdjustFieldsOnEditAutoCode> //</hideLine>
            //<generatedAutoCode>
            ...
            //</detailForm-2849843-23608167-CreateDataOnEditAutoCode> //</hideLine>
            //<generatedAutoCode>
            $data = new stdClass;
            ...
            //</detailForm-2849843-23608167-SendDataOnEditAutoCode> //</hideLine>
            //<generatedAutoCode>
...
//</generated-DatagridAction-onEditDetailPessoaEndereco>
//<generated-DatagridAction-onDeleteDetailPessoaEndereco>
    public static function onDeleteDetailPessoaEndereco($param = null) 
    {
        try
        {
            //</detailForm-2849843-23608167-ClearDataOnDeleteAutoCode> //</hideLine>
            //<generatedAutoCode>
            $__row__data = unserialize(base64_decode($param['__row__data']));
            ...
            //</detailForm-2849843-23608167-SendDataOnDeleteAutoCode> //</hideLine>
            //<generatedAutoCode>
            TForm::sendData(self::$formName, $data);

            //</generatedAutoCode>

            //</detailForm-2849843-23608167-RemoveRowOnDeleteAutoCode> //</hideLine>
            //<generatedAutoCode>
        ...
        try
        {
            ...
            if($data->cpf_cnpj){
                ...
                if($countCPF_CNPJ>0 && $data->tipo_pessoa_id==TipoPessoa::FISICA){
                    $verificarGrupoAtual = PessoaGrupo::where('grupo_id','=',Grupo::PARCEIRO)
                                                    ->where('pessoa_id','=',$searchCPF_CNPJ->id)
                                                    ->count();
                    $pageParam['pessoa_id'] = $searchCPF_CNPJ->id;
                    if($verificarGrupoAtual>0){
                        new TQuestion("Este CPF já está cadastrado como parceiro. Deseja editar o cadastro existente?", new TAction([__CLASS__, 'onEditarParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }else{
                        new TQuestion("Este CPF já está cadastrado. Deseja adicionar como parceiro?", new TAction([__CLASS__, 'onAdicionarGrupoParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }
                    ...
                    $pageParam['pessoa_id'] = $searchCPF_CNPJ->id;
                    if($verificarGrupoAtual>0){
                        new TQuestion("Este CNPJ já está cadastrado como parceiro. Deseja editar o cadastro existente?", new TAction([__CLASS__, 'onEditarParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }else{
                        new TQuestion("Este CNPJ já está cadastrado. Deseja adicionar como parceiro?", new TAction([__CLASS__, 'onAdicionarGrupoParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }
                }
            }
            ...
            if($data->rg_ie){
                ...
                if($countCPF_CNPJ>0 && $data->tipo_pessoa_id==TipoPessoa::FISICA){
                    ...
                    $pageParam['pessoa_id'] = $searchCPF_CNPJ->id;
                    if($verificarGrupoAtual>0){
                        new TQuestion("Este RG já está cadastrado como parceiro. Deseja editar o cadastro existente?", new TAction([__CLASS__, 'onEditarParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }else{
                        new TQuestion("Este RG já está cadastrado. Deseja adicionar como parceiro?", new TAction([__CLASS__, 'onAdicionarGrupoParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }
                }elseif($countCPF_CNPJ>0 && $data->tipo_pessoa_id==TipoPessoa::JURIDICA){
                    $verificarGrupoAtual = PessoaGrupo::where('grupo_id','=',Grupo::PARCEIRO)
                    ...
                    $pageParam['pessoa_id'] = $searchCPF_CNPJ->id;
                    if($verificarGrupoAtual>0){
                        new TQuestion("Esta Inscrição Estadual já está cadastrada como parceiro. Deseja editar o cadastro existente?", new TAction([__CLASS__, 'onEditarParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }else{
                        new TQuestion("Esta Inscrição Estadual já está cadastrada. Deseja adicionar como parceiro?", new TAction([__CLASS__, 'onAdicionarGrupoParceiro'], $pageParam), new TAction([__CLASS__, 'btnNaoTQuestion'], $pageParam));
                        exit;
                    }
                }
            }
...
//</generatedAutoCode>
    ...
    //<detailForm-2849843-23608167> //</hideLine>
            $pessoa_endereco_pessoa_items = $this->storeMasterDetailItems('PessoaEndereco', 'pessoa_id', 'pessoa_endereco_pessoa', $object, $param['pessoa_endereco_pessoa_list___row__data'] ?? [], $this->form, $this->pessoa_endereco_pessoa_list, function($masterObject, $detailObject){ //</blockLine>

                //code here

                //</autoCode>
            }, $this->pessoa_endereco_pessoa_criteria); //</blockLine>
    //</hideLine> //</detailForm-2849843-23608167>
            ...
            if(!$data->id)
            {
                ...
                $pessoaGrupo->grupo_id = Grupo::PARCEIRO;
                $pessoaGrupo->store();    
            }
...
//</generatedAutoCode>
            ...
            if(isset($param['page'])){
                TApplication::loadPage('ParceirosHeaderList', 'onShow');
            }
...
//</generatedAutoCode>
    ...
    //<detailForm-2849843-23608167> //</hideLine>
                $pessoa_endereco_pessoa_items = $this->loadMasterDetailItems('PessoaEndereco', 'pessoa_id', 'pessoa_endereco_pessoa', $object, $this->form, $this->pessoa_endereco_pessoa_list, $this->pessoa_endereco_pessoa_criteria, function($masterObject, $detailObject, $objectItems){ //</blockLine>
...
//</generated-onEdit>
    ...
    //</hideLine> <addUserFunctionsCode/>
     ...
     //<generated-userFunction-onVisualizarCadastrado>
...
//</generated-userFunction-onVisualizarCadastrado>
     ...
     //<generated-userFunction-onContinuarCadastro>
...
//</generated-userFunction-onContinuarCadastro>
     ...
     //<generated-userFunction-onAdicionarGrupoParceiro>
    public static function onAdicionarGrupoParceiro($param = null) 
    {
        try 
        {
            TTransaction::open(self::$database); 
            ...
            $objeto->grupo_id = Grupo::PARCEIRO;
            $objeto->store();
            TApplication::loadPage('ParceirosHeaderList', 'onShow');
            TTransaction::close();
        }
...
//</generated-userFunction-onAdicionarGrupoParceiro>
     ...
     //<generated-userFunction-onEditarParceiro>
    public static function onEditarParceiro($param = null) 
    {
        try 
        {
            $pageParam = ['key' => $param['pessoa_id']]; // ex.: = ['key' => 10]
            TApplication::loadPage('ParceiroForm', 'onEdit', $pageParam);
        }
        catch (Exception $e) 
        {
            new TMessage('error', $e->getMessage());    
...
//</generated-userFunction-onEditarParceiro>
     ...
     //<generated-userFunction-btnNaoTQuestion>
