...
class ContraparteList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de parte contraria");
        $this->limit = 20;

        $criteria_tipo_pessoa_id = new TCriteria();
        $criteria_tipo_pessoa_nome_col = new TCriteria();
        ...
        $tipo_pessoa_nome_col = new TDBCombo('tipo_pessoa_nome_col', 'escritorio', 'TipoPessoa', 'id', '{nome}','nome asc' , $criteria_tipo_pessoa_nome_col );
        ...
        $tipo_pessoa_nome_col->setChangeAction(new TAction([$this, 'onSearch'], ['static'=>'1']));
        ...
        $tipo_pessoa_nome_col->enableSearch();
        ...
        $tipo_pessoa_nome_col->setSize('100%');
        ...
        $row2 = $this->form->addFields([new TLabel("Documento:", null, '14px', null),$cpf_cnpj],[new TLabel("Email:", null, '14px', null),$email],[new TLabel("Telefone:", null, '14px', null, '100%'),$telefone]);
        ...
        $action_onEdit = new TDataGridAction(array('ContraparteForm', 'onEdit'));
        ...
        $tr->add($td_email_col);
        $td_tipo_pessoa_nome_col = TElement::tag('td', $tipo_pessoa_nome_col);
        $tr->add($td_tipo_pessoa_nome_col);
        $tr->add(TElement::tag('td', ''));
        ...
        $this->datagrid_form->addField($tipo_pessoa_nome_col);
        ...
        $panel = new TPanelGroup("Listagem de parte contraria");
        ...
        $button_buscar->setAction(new TAction(['ContraparteList', 'onGlobalSearch']), "Buscar");
        ...
        $button_cadastrar->setAction(new TAction(['ContraparteForm', 'onShow']), "Cadastrar");
        ...
        $button_filtros->setAction(new TAction(['ContraparteList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_atualizar->setAction(new TAction(['ContraparteList', 'onRefresh']), "Atualizar");
        ...
        $button_limpar_filtros->setAction(new TAction(['ContraparteList', 'onClearFilters']), "Limpar filtros");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ContraparteList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ContraparteList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ContraparteList', 'onExportXls']), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Pessoas","Partes Contraria"]));
        }
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'ContraparteListSearch');
            $page->setProperty('page_name', 'ContraparteListSearch');
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->tipo_pessoa_nome_col) AND ( (is_scalar($data->tipo_pessoa_nome_col) AND $data->tipo_pessoa_nome_col !== '') OR (is_array($data->tipo_pessoa_nome_col) AND (!empty($data->tipo_pessoa_nome_col)) )) )
        {

            $filters[] = new TFilter('tipo_pessoa_id', '=', $data->tipo_pessoa_nome_col);// create the filter 
        }
