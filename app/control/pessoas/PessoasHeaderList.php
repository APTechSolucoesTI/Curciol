...
class PessoasHeaderList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $column__transformed = new TDataGridColumn('', "Cadastros", 'center');
        ...
        $button_buscar->setAction(new TAction(['PessoasHeaderList', 'onGlobalSearch']), "Buscar");
        ...
        $button_filtros->setAction(new TAction(['PessoasHeaderList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_atualizar->setAction(new TAction(['PessoasHeaderList', 'onRefresh']), "Atualizar");
        ...
        $button_limpar_filtros->setAction(new TAction(['PessoasHeaderList', 'onClearFilters']), "Limpar filtros");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['PessoasHeaderList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['PessoasHeaderList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['PessoasHeaderList', 'onExportXls']), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'PessoasHeaderListSearch');
            $page->setProperty('page_name', 'PessoasHeaderListSearch');
