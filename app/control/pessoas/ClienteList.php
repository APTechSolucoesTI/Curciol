...
class ClienteList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $button_buscar->setAction(new TAction(['ClienteList', 'onGlobalSearch']), "Buscar");
        ...
        $button_filtros->setAction(new TAction(['ClienteList', 'onShowCurtainFilters']), "Filtros");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ClienteList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        ...
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ClienteList', 'onExportXls']), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
