...
END;
CREATE SEQUENCE modelo_documento_misto_id_seq START WITH 1 INCREMENT BY 1; 

CREATE OR REPLACE TRIGGER modelo_documento_misto_id_seq_tr 

BEFORE INSERT ON modelo_documento_misto FOR EACH ROW 
    ...
    BEGIN 
        ...
        SELECT modelo_documento_misto_id_seq.NEXTVAL INTO :NEW.id FROM DUAL; 
