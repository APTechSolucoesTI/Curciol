...
ALTER TABLE area ADD CONSTRAINT area_6a95d4a9f38c7 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE area ADD CONSTRAINT area_6a95d4a9f3950 FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_6a95d4aa037ab FOREIGN KEY (contraparte_id) references contraparte(id); 
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_6a95d4aa03848 FOREIGN KEY (pessoa_id) references pessoa(id); 
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_6a95d4aa038b8 FOREIGN KEY (classificacoes_contraparte_dados_id) references classificacoes_contraparte_dados(id); 
...
ALTER TABLE classificacoes_contraparte_dados ADD CONSTRAINT classificacoes_contraparte_dados_6a95d4aa03d2f FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE contrato_documento ADD CONSTRAINT contrato_documento_6a95d4aa0877f FOREIGN KEY (contrato_id) references contrato(id); 
...
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa0996a FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa09a0b FOREIGN KEY (modificacao_user_id) references system_users(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa09a88 FOREIGN KEY (contrato_opcao_pagamento_id) references contrato_pagamento_opcao(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa09af1 FOREIGN KEY (contrato_evento_id) references contrato_pagamento_evento(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa09b50 FOREIGN KEY (contrato_indexador_id) references contrato_pagamento_indexador(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa09bb8 FOREIGN KEY (contrato_id) references contrato(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa09c38 FOREIGN KEY (unidade_indexador_id) references unidade_indexador(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6a95d4aa09c9f FOREIGN KEY (status_contrato_pagamento_id) references status_contrato_pagamento(id); 
...
ALTER TABLE contrato_representante ADD CONSTRAINT contrato_representante_6a95d4aa0aa8e FOREIGN KEY (contrato_id) references contrato(id); 
ALTER TABLE contrato_representante ADD CONSTRAINT contrato_representante_6a95d4aa0aae3 FOREIGN KEY (representante_id) references pessoa(id); 
...
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_6a95d4aa0b390 FOREIGN KEY (agenda_id) references agenda(id); 
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_6a95d4aa0b404 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_6a95d4aa0b465 FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE lancamento_profissional_ajuste ADD CONSTRAINT lancamento_profissional_ajuste_6a95d4aa0ff13 FOREIGN KEY (lancamento_profissional_id) references lancamento_profissional(id); 
...
ALTER TABLE orgao ADD CONSTRAINT orgao_6a95d4aa12626 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE orgao ADD CONSTRAINT orgao_6a95d4aa12694 FOREIGN KEY (modificacao_user_id) references system_users(id); 
ALTER TABLE padrao_atendimento_documento ADD CONSTRAINT padrao_atendimento_documento_6a95d4aa129b5 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE padrao_atendimento_documento ADD CONSTRAINT padrao_atendimento_documento_6a95d4aa12a29 FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE pessoa_representantes_legais ADD CONSTRAINT pessoa_representantes_legais_6a95d4aa14891 FOREIGN KEY (pessoa_juridica_id) references pessoa(id); 
ALTER TABLE pessoa_representantes_legais ADD CONSTRAINT pessoa_representantes_legais_6a95d4aa14918 FOREIGN KEY (representante_id) references pessoa(id); 
...
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6a95d4aa1811e FOREIGN KEY (pessoa_id) references pessoa(id); 
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6a95d4aa1817a FOREIGN KEY (entidade_devedora_id) references pessoa(id); 
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6a95d4aa181d3 FOREIGN KEY (requisicao_pagamento_id) references requisicao_pagamento(id); 
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6a95d4aa18226 FOREIGN KEY (status_requisicao_pagamento_id) references status_requisicao_pagamento(id); 
ALTER TABLE requisicao_pagamento_etapa2 ADD CONSTRAINT requisicao_pagamento_etapa2_6a95d4aa18519 FOREIGN KEY (processo_filho_id) references processo(id); 
ALTER TABLE requisicao_pagamento_etapa2 ADD CONSTRAINT requisicao_pagamento_etapa2_6a95d4aa1856e FOREIGN KEY (requisicao_pagamento_cliente_id) references requisicao_pagamento_cliente(id); 
ALTER TABLE requisicao_pagamento_etapa3 ADD CONSTRAINT requisicao_pagamento_etapa3_6a95d4aa1880c FOREIGN KEY (requisicao_pagamento_cliente_id) references requisicao_pagamento_cliente(id); 
ALTER TABLE requisicao_pagamento_etapa3 ADD CONSTRAINT requisicao_pagamento_etapa3_6a95d4aa1887e FOREIGN KEY (processo_filho_id) references processo(id); 
...
ALTER TABLE status_processual ADD CONSTRAINT status_processual_6a95d4aa19611 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE status_processual ADD CONSTRAINT status_processual_6a95d4aa1968e FOREIGN KEY (modificacao_user_id) references system_users(id); 
