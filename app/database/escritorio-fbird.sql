...
ALTER TABLE area ADD CONSTRAINT area_690ba3e0a03cf FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE area ADD CONSTRAINT area_690ba3e0a0445 FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_690ba3e0a323e FOREIGN KEY (contraparte_id) references contraparte(id); 
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_690ba3e0a32ae FOREIGN KEY (pessoa_id) references pessoa(id); 
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_690ba3e0a3335 FOREIGN KEY (classificacoes_contraparte_dados_id) references classificacoes_contraparte_dados(id); 
...
ALTER TABLE classificacoes_contraparte_dados ADD CONSTRAINT classificacoes_contraparte_dados_690ba3e0a361f FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE contrato_documento ADD CONSTRAINT contrato_documento_690ba3e0a6c8e FOREIGN KEY (contrato_id) references contrato(id); 
...
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_690ba3e0a7bce FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_690ba3e0a7c52 FOREIGN KEY (modificacao_user_id) references system_users(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_690ba3e0a7cee FOREIGN KEY (contrato_opcao_pagamento_id) references contrato_pagamento_opcao(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_690ba3e0a7d7c FOREIGN KEY (contrato_evento_id) references contrato_pagamento_evento(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_690ba3e0a7df4 FOREIGN KEY (contrato_indexador_id) references contrato_pagamento_indexador(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_690ba3e0a7e63 FOREIGN KEY (contrato_id) references contrato(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_690ba3e0a7ed1 FOREIGN KEY (unidade_indexador_id) references unidade_indexador(id); 
...
ALTER TABLE contrato_representante ADD CONSTRAINT contrato_representante_690ba3e0a8c4d FOREIGN KEY (contrato_id) references contrato(id); 
ALTER TABLE contrato_representante ADD CONSTRAINT contrato_representante_690ba3e0a8cb6 FOREIGN KEY (representante_id) references pessoa(id); 
...
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_690ba3e0a9538 FOREIGN KEY (agenda_id) references agenda(id); 
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_690ba3e0a95ab FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_690ba3e0a960c FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE orgao ADD CONSTRAINT orgao_690ba3e0ae648 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE orgao ADD CONSTRAINT orgao_690ba3e0ae6bf FOREIGN KEY (modificacao_user_id) references system_users(id); 
ALTER TABLE padrao_atendimento_documento ADD CONSTRAINT padrao_atendimento_documento_690ba3e0ae8e3 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE padrao_atendimento_documento ADD CONSTRAINT padrao_atendimento_documento_690ba3e0ae93c FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE pessoa_representantes_legais ADD CONSTRAINT pessoa_representantes_legais_690ba3e0b014a FOREIGN KEY (pessoa_juridica_id) references pessoa(id); 
ALTER TABLE pessoa_representantes_legais ADD CONSTRAINT pessoa_representantes_legais_690ba3e0b0197 FOREIGN KEY (representante_id) references pessoa(id); 
...
ALTER TABLE status_processual ADD CONSTRAINT status_processual_690ba3e0b2f6e FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE status_processual ADD CONSTRAINT status_processual_690ba3e0b2fd8 FOREIGN KEY (modificacao_user_id) references system_users(id); 
