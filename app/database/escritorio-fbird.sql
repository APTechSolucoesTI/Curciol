...
CREATE TABLE whatsapp_config( 
 ...
 CREATE UNIQUE INDEX unique_idx_modelo_documento_misto_modelo_documento_id ON modelo_documento_misto COMPUTED BY (modelo_documento_id);
...
ALTER TABLE area ADD CONSTRAINT area_6ab1325b79393 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE area ADD CONSTRAINT area_6ab1325b79403 FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_6ab1325b7c28c FOREIGN KEY (contraparte_id) references contraparte(id); 
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_6ab1325b7c2da FOREIGN KEY (pessoa_id) references pessoa(id); 
ALTER TABLE classificacoes_contraparte ADD CONSTRAINT classificacoes_contraparte_6ab1325b7c334 FOREIGN KEY (classificacoes_contraparte_dados_id) references classificacoes_contraparte_dados(id); 
...
ALTER TABLE classificacoes_contraparte_dados ADD CONSTRAINT classificacoes_contraparte_dados_6ab1325b7c5f3 FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE contrato_documento ADD CONSTRAINT contrato_documento_6ab1325b7f6dd FOREIGN KEY (contrato_id) references contrato(id); 
...
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b80374 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b803f8 FOREIGN KEY (modificacao_user_id) references system_users(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b80481 FOREIGN KEY (contrato_opcao_pagamento_id) references contrato_pagamento_opcao(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b804ec FOREIGN KEY (contrato_evento_id) references contrato_pagamento_evento(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b80552 FOREIGN KEY (contrato_indexador_id) references contrato_pagamento_indexador(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b805b7 FOREIGN KEY (contrato_id) references contrato(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b80618 FOREIGN KEY (unidade_indexador_id) references unidade_indexador(id); 
ALTER TABLE contrato_pagamento_parcela ADD CONSTRAINT contrato_pagamento_parcela_6ab1325b80680 FOREIGN KEY (status_contrato_pagamento_id) references status_contrato_pagamento(id); 
...
ALTER TABLE contrato_representante ADD CONSTRAINT contrato_representante_6ab1325b81299 FOREIGN KEY (contrato_id) references contrato(id); 
ALTER TABLE contrato_representante ADD CONSTRAINT contrato_representante_6ab1325b812ec FOREIGN KEY (representante_id) references pessoa(id); 
...
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_6ab1325b81b35 FOREIGN KEY (agenda_id) references agenda(id); 
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_6ab1325b81bab FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE convidado_compromisso ADD CONSTRAINT convidado_compromisso_6ab1325b81c1b FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE lancamento_profissional_ajuste ADD CONSTRAINT lancamento_profissional_ajuste_6ab1325b85f24 FOREIGN KEY (lancamento_profissional_id) references lancamento_profissional(id); 
...
ALTER TABLE orgao ADD CONSTRAINT orgao_6ab1325b88202 FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE orgao ADD CONSTRAINT orgao_6ab1325b88273 FOREIGN KEY (modificacao_user_id) references system_users(id); 
ALTER TABLE padrao_atendimento_documento ADD CONSTRAINT padrao_atendimento_documento_6ab1325b884bf FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE padrao_atendimento_documento ADD CONSTRAINT padrao_atendimento_documento_6ab1325b88528 FOREIGN KEY (modificacao_user_id) references system_users(id); 
...
ALTER TABLE pessoa_representantes_legais ADD CONSTRAINT pessoa_representantes_legais_6ab1325b89d89 FOREIGN KEY (pessoa_juridica_id) references pessoa(id); 
ALTER TABLE pessoa_representantes_legais ADD CONSTRAINT pessoa_representantes_legais_6ab1325b89dcd FOREIGN KEY (representante_id) references pessoa(id); 
...
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6ab1325b8cdbc FOREIGN KEY (pessoa_id) references pessoa(id); 
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6ab1325b8ce06 FOREIGN KEY (entidade_devedora_id) references pessoa(id); 
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6ab1325b8ce5e FOREIGN KEY (requisicao_pagamento_id) references requisicao_pagamento(id); 
ALTER TABLE requisicao_pagamento_cliente ADD CONSTRAINT requisicao_pagamento_cliente_6ab1325b8ceba FOREIGN KEY (status_requisicao_pagamento_id) references status_requisicao_pagamento(id); 
ALTER TABLE requisicao_pagamento_etapa2 ADD CONSTRAINT requisicao_pagamento_etapa2_6ab1325b8d14c FOREIGN KEY (processo_filho_id) references processo(id); 
ALTER TABLE requisicao_pagamento_etapa2 ADD CONSTRAINT requisicao_pagamento_etapa2_6ab1325b8d1ac FOREIGN KEY (requisicao_pagamento_cliente_id) references requisicao_pagamento_cliente(id); 
ALTER TABLE requisicao_pagamento_etapa3 ADD CONSTRAINT requisicao_pagamento_etapa3_6ab1325b8d44a FOREIGN KEY (requisicao_pagamento_cliente_id) references requisicao_pagamento_cliente(id); 
ALTER TABLE requisicao_pagamento_etapa3 ADD CONSTRAINT requisicao_pagamento_etapa3_6ab1325b8d4b3 FOREIGN KEY (processo_filho_id) references processo(id); 
...
ALTER TABLE status_processual ADD CONSTRAINT status_processual_6ab1325b8e14b FOREIGN KEY (criacao_user_id) references system_users(id); 
ALTER TABLE status_processual ADD CONSTRAINT status_processual_6ab1325b8e1b9 FOREIGN KEY (modificacao_user_id) references system_users(id); 
