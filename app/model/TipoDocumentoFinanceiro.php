...
class TipoDocumentoFinanceiro extends TRecord
{
    const TABLENAME  = 'tipo_documento_financeiro';
    const PRIMARYKEY = 'id';
    ...
    private TipoDocFinanceiroPadrao $padrao;
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('gera_codigo');
        parent::addAttribute('padrao_id');
    ...
    /**
     * Method set_tipo_doc_financeiro_padrao
     * Sample of usage: $var->tipo_doc_financeiro_padrao = $object;
     * @param $object Instance of TipoDocFinanceiroPadrao
     */
    public function set_padrao(TipoDocFinanceiroPadrao $object)
    {
        $this->padrao = $object;
        $this->padrao_id = $object->id;
    }

    /**
     * Method get_padrao
     * Sample of usage: $var->padrao->attribute;
     * @returns TipoDocFinanceiroPadrao instance
     */
    public function get_padrao()
    {
    
        // loads the associated object
        if (empty($this->padrao))
            $this->padrao = new TipoDocFinanceiroPadrao($this->padrao_id);
    ...
    public function getContas()
    {
        ...
        $criteria->add(new TFilter('tipo_documento_financeiro_id', '=', $this->id));
    ...
    public function get_conta_pessoa_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('pessoa_id','{pessoa->nome}');
    ...
    public function get_conta_categoria_conta_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('categoria_conta_id','{categoria_conta->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_tipo_conta_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('tipo_conta_id','{tipo_conta->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_escritorio_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('escritorio_id','{escritorio->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_tipo_documento_financeiro_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('tipo_documento_financeiro_id','{tipo_documento_financeiro->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_atendimento_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('atendimento_id','{atendimento->id}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_contrato_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('contrato_id','{contrato->objeto}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_profissional_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('profissional_id','{profissional->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_processo_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('processo_id','{processo->numero_cnj_numero}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_criacao_user_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('criacao_user_id','{criacao_user->name}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_modificacao_user_to_string()
    {
        ...
        $values = Conta::where('tipo_documento_financeiro_id', '=', $this->id)->getIndexedArray('modificacao_user_id','{modificacao_user->name}');
        return implode(', ', $values);
    }
