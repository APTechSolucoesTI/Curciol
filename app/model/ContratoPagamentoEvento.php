...
class ContratoPagamentoEvento extends TRecord
{
    const TABLENAME  = 'contrato_pagamento_evento';
    const PRIMARYKEY = 'id';
    ...
    public function getContratoPagamentoParcelas()
    {
        ...
        $criteria->add(new TFilter('contrato_evento_id', '=', $this->id));
    ...
    public function get_contrato_pagamento_parcela_contrato_to_string()
    {
        ...
        $values = ContratoPagamentoParcela::where('contrato_evento_id', '=', $this->id)->getIndexedArray('contrato_id','{contrato->objeto}');
    ...
    public function get_contrato_pagamento_parcela_contrato_opcao_pagamento_to_string()
    {
        ...
        $values = ContratoPagamentoParcela::where('contrato_evento_id', '=', $this->id)->getIndexedArray('contrato_opcao_pagamento_id','{contrato_opcao_pagamento->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_contrato_pagamento_parcela_contrato_evento_to_string()
    {
        ...
        $values = ContratoPagamentoParcela::where('contrato_evento_id', '=', $this->id)->getIndexedArray('contrato_evento_id','{contrato_evento->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_contrato_pagamento_parcela_unidade_indexador_to_string()
    {
        ...
        $values = ContratoPagamentoParcela::where('contrato_evento_id', '=', $this->id)->getIndexedArray('unidade_indexador_id','{unidade_indexador->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_contrato_pagamento_parcela_contrato_indexador_to_string()
    {
        ...
        $values = ContratoPagamentoParcela::where('contrato_evento_id', '=', $this->id)->getIndexedArray('contrato_indexador_id','{contrato_indexador->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_contrato_pagamento_parcela_criacao_user_to_string()
    {
        ...
        $values = ContratoPagamentoParcela::where('contrato_evento_id', '=', $this->id)->getIndexedArray('criacao_user_id','{criacao_user->name}');
        return implode(', ', $values);
    }
    ...
    public function get_contrato_pagamento_parcela_modificacao_user_to_string()
    {
        ...
        $values = ContratoPagamentoParcela::where('contrato_evento_id', '=', $this->id)->getIndexedArray('modificacao_user_id','{modificacao_user->name}');
        return implode(', ', $values);
    }
