...
class Contraparte extends TRecord
{
    const TABLENAME  = 'contraparte';
    const PRIMARYKEY = 'id';
    ...
    public function getClassificacoesContrapartes()
    {
        ...
        $criteria->add(new TFilter('contraparte_id', '=', $this->id));
    ...
    public function get_classificacoes_contraparte_contraparte_to_string()
    {
        ...
        $values = ClassificacoesContraparte::where('contraparte_id', '=', $this->id)->getIndexedArray('contraparte_id','{contraparte->id}');
    ...
    public function get_classificacoes_contraparte_pessoa_to_string()
    {
        ...
        $values = ClassificacoesContraparte::where('contraparte_id', '=', $this->id)->getIndexedArray('pessoa_id','{pessoa->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_classificacoes_contraparte_classificacoes_contraparte_dados_to_string()
    {
        ...
        $values = ClassificacoesContraparte::where('contraparte_id', '=', $this->id)->getIndexedArray('classificacoes_contraparte_dados_id','{classificacoes_contraparte_dados->nome}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(ClassificacoesContraparte::where('contraparte_id', '=', $this->id)->first())
        {
