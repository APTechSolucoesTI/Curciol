...
class TarefaVinculo extends TRecord
{
    const TABLENAME  = 'tarefa_vinculo';
    const PRIMARYKEY = 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('subtarefa_id');
     ...
     * @param $object Instance of Tarefa
     */
    public function set_subtarefa(Tarefa $object)
    {
        $this->subtarefa = $object;
        $this->subtarefa_id = $object->id;
    }

    /**
     * Method get_subtarefa
     * Sample of usage: $var->subtarefa->attribute;
     * @returns Tarefa instance
     */
    public function get_subtarefa()
    {
    
        // loads the associated object
        if (empty($this->subtarefa))
            $this->subtarefa = new Tarefa($this->subtarefa_id);
    
        // returns the associated object
        return $this->subtarefa;
    }
    /**
