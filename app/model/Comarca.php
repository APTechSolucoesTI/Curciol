...
class Comarca extends TRecord
{
    const TABLENAME  = 'comarca';
    const PRIMARYKEY = 'id';
    ...
    public function getProcessos()
    {
        ...
        $criteria->add(new TFilter('comarca_id', '=', $this->id));
    ...
    public function get_processo_tipo_processo_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('tipo_processo_id','{tipo_processo->nome}');
    ...
    public function get_processo_tribunal_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('tribunal_id','{tribunal->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_foro_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('foro_id','{foro->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_comarca_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('comarca_id','{comarca->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_vara_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('vara_id','{vara->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_orgao_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('orgao_id','{orgao->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_area_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('area_id','{area->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_assunto_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('assunto_id','{assunto->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_status_processual_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('status_processual_id','{status_processual->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_responsavel_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('responsavel_id','{responsavel->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_envolvimento_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('envolvimento_id','{envolvimento->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_criacao_user_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('criacao_user_id','{criacao_user->name}');
        return implode(', ', $values);
    }
    ...
    public function get_processo_modificacao_user_to_string()
    {
        ...
        $values = Processo::where('comarca_id', '=', $this->id)->getIndexedArray('modificacao_user_id','{modificacao_user->name}');
        return implode(', ', $values);
    }
