...
class TipoPrazo extends TRecord
{
    const TABLENAME  = 'tipo_prazo';
    const PRIMARYKEY = 'id';
    ...
    public function getConfigBuscaPrazos()
    {
        ...
        $criteria->add(new TFilter('tipo_prazo_id', '=', $this->id));
    ...
    public function get_config_busca_prazo_tipo_prazo_to_string()
    {
        ...
        $values = ConfigBuscaPrazo::where('tipo_prazo_id', '=', $this->id)->getIndexedArray('tipo_prazo_id','{tipo_prazo->nome}');
    ...
    public function get_config_busca_prazo_config_busca_a_partir_to_string()
    {
        ...
        $values = ConfigBuscaPrazo::where('tipo_prazo_id', '=', $this->id)->getIndexedArray('config_busca_a_partir_id','{config_busca_a_partir->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_config_busca_prazo_criacao_user_to_string()
    {
        ...
        $values = ConfigBuscaPrazo::where('tipo_prazo_id', '=', $this->id)->getIndexedArray('criacao_user_id','{criacao_user->name}');
        return implode(', ', $values);
    }
    ...
    public function get_config_busca_prazo_modificacao_user_to_string()
    {
        ...
        $values = ConfigBuscaPrazo::where('tipo_prazo_id', '=', $this->id)->getIndexedArray('modificacao_user_id','{modificacao_user->name}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(ConfigBuscaPrazo::where('tipo_prazo_id', '=', $this->id)->first())
        {
