...
class Nacionalidade extends TRecord
{
    ...
    public function get_pessoa_system_users_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_sexo_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('sexo_id','{sexo->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_nacionalidade_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('nacionalidade_id','{nacionalidade->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_estado_civil_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('estado_civil_id','{estado_civil->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_situacao_profissional_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('situacao_profissional_id','{situacao_profissional->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_tipo_profissional_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('tipo_profissional_id','{tipo_profissional->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_criacao_user_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('criacao_user_id','{criacao_user->name}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_modificacao_user_to_string()
    {
        ...
        $values = Pessoa::where('nacionalidade_id', '=', $this->id)->getIndexedArray('modificacao_user_id','{modificacao_user->name}');
        return implode(', ', $values);
    }
